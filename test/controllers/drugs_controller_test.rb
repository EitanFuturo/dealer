...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { frecuency: @drug.frecuency, name: @drug.name } }, as: :json
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { frecuency: @drug.frecuency, name: @drug.name } }, as: :json
    assert_response 200
  end
